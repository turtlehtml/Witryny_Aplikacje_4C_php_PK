...
<body>
    ...
    <div>
        Do stałej DOBRA_RADA stosuje funkcje <strong>strlen</strong>: <?php echo strlen (DOBRA_RADA);?><br>
        Do stałej DOBRA_RADA stosuje funkcje <strong>str_word_count</strong>: <?php echo str_word_count (DOBRA_RADA);?> <br>
        Do stałej DOBRA_RADA stosuje funkcje <strong>strrev</strong>: <?php echo strrev (DOBRA_RADA);?> <br>
        Do stałej DOBRA_RADA stosuje funkcje <strong>strpos</strong>: <?= strpos (DOBRA_RADA,"to");?>  <br>
        Do stałej DOBRA_RADA stosuje funkcje <strong>str_replace</strong>: <?= str_replace ("chleba","mięsa",DOBRA_RADA);?> <br>
